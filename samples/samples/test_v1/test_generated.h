...
struct Record FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<int64_t> *mutable_ids() { return GetPointer<flatbuffers::Vector<int64_t> *>(4); }
  const flatbuffers::String *strings() const { return GetPointer<const flatbuffers::String *>(6); }
  flatbuffers::String *mutable_strings() { return GetPointer<flatbuffers::String *>(6); }
...
inline Record *GetMutableRecord(void *buf) { return flatbuffers::GetMutableRoot<Record>(buf); }
